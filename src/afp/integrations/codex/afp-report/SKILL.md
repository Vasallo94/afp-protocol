...
If you found a workaround, that is a *strong* signal to file — the workaround
...
3. **Build and deposit as a draft**:
   ...
   To install this Codex skill globally:
   `afp integrations install codex --global`

   The default global destination is `~/.codex/skills/afp-report`.
